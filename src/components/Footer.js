...
export const Footer = () => {
  return (
    <footer className="bg-white dark:bg-gray-900 z-50 relative">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
          <a href="#" className="text-white font-bold text-xl justify-between flex"> <img src={Logo} className='w-6 h-6 mr-4'/> <span>Seredityfy </span></a>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Seredityfy™</a>. All Rights Reserved.
          </span>

...
export const NotifyComponents = ({img,titleContent,dateContent,keys}) => {
    return (
        <div key={keys} className='py-[0.5px] mb-[70px] lg:mr-6  bg-gradient-to-r from-indigo-600 via-cyan-400 to-indigo-600 h-[0.5px]  '>

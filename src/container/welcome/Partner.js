  ...
  return (
    <div className='flex flex-col bg-gradient-135 from-slate-700 via-grey-900 to-fuchsia-900 h-full backdrop-blur-3xl bg-opacity-5'>
      <div className='bg-blue-950 h-full bg-opacity-10 backdrop-blur-3xl'>
        ...
        <h1 className='leading-5 font-medium text-4xl text-white'>Seredityfy Partner</h1>
        <h3 className='leading-5 font-medium text-4xl  text-white'>Most Partner ever support deep AI Image and 3D generator </h3>
        <p className='mx-auto w-9/12 text-center  text-white'>An imaginative collage showcasing characters, landscapes, and icons representing collaborative storytelling. Diverse people coming together, a fantasy realm, and thought bubbles hinting at creative ideas merge into an artistic mosaic, symbolizing the unity and boundless imagination found on Serendipityfy.</p>
      </div>
